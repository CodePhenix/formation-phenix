    ...
    <main>
        ...
        <section>
          <div>
            ...
            <div>
              <ul>
                <li><a href="documentations/html.php">HTML</a></li>
                <li><a href="documentations/css.php">CSS</a></li>
        ...
        <a class="section" href="formation-continue/index.php">
        <section>
          <div>
            <div>
