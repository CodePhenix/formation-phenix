    ...
    <main>
        ...
        <section>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <p>Cet exercice va vous permettre de vous exercer et d'apprendre les différents sélecteurs CSS. <br>
                            <b>Les niveaux de 1 à 17 puis de 27 à 29 sont important à connaître</b>.
                        </p>
            ...
            <article id="js-formulaire-article">
                ...
                <a class="cta link" target="_blank" href="https://regex101.com"><span>Utiliser l'outil ReGex</span> <i class="bi bi-arrow-right-circle-fill"></i></a>
                <h4>Exercices</h4>
                <ol>
                    <li>
            ...
            <article id="git-init-article">
                ...
                <ol>
                    <li>
                        <p>Reproduisez le site, en mobile first, selon les maquettes. Vous devrez créer 2 commits :</p>
                        <ul>
