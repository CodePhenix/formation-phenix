  ...
  <body>
    ...
    <main>
      ...
      <ol class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <!--
        <li>
          <button style="color:#ccc;cursor:default;" class="nav-link" id="js-avance-tab" data-bs-toggle="pill" data-bs-target="#js-avance" type="button" role="tab" aria-controls="js-avance" aria-selected="false">
            Javascript avancé
          </button>
        </li>
        -->
      ...
      <!-- HTML INITIATION-->
        <article class="tab-pane fade show active" id="html-initiation" role="tabpanel" aria-labelledby="html-initiation-tab">
          <h3>HTML initiation</h3>
           ...
           <p>Il est temps maintenant de passer à la pratique. Pour vous exercer vous pouvez construire au
           choix, votre cv ou votre porte folio. Essayez d'utiliser toutes les notions vues dans ce cours. Vous pouvez également vous aider de
        ...
        <article class="tab-pane fade" id="css-initiation" role="tabpanel" aria-labelledby="css-initiation-tab">
          ...
          <h4>Demo CSS</h4>
            ...
            <h4>Exercice pratique</h4>
            <p>Maintenant que vous avez des connaissances en CSS, il est temps de passer à la pratique. Pour
            vous exercer, vous pouvez mettre en forme et styliser votre cv ou votre porte folio, <b>avec une
            feuille de style liée à votre fichier HTML</b>.</p>
            <p>Essayez d'utiliser toutes les notions vues dans ce cours. Vous pouvez également vous aider de
            la documentation fournie.</p>
          <h4>Exercice</h4>
          ...
          <p><small>Attention, le nom des balises dans cet exercice ne sont pas de vrai nom de balise.</small></p>
        ...
        <article class="tab-pane fade" id="formulaires" role="tabpanel" aria-labelledby="formulaires-tab">
          ...
          <h4>Exercice pratique</h4>
          <p>Vous pouvez maintenant continuer votre exercice pratique, en y ajoutant un formulaire de contact.</p>
        </article>
        <article class="tab-pane fade" id="positionnement" role="tabpanel" aria-labelledby="positionnement-tab">
          ...
          <ol>
            ...
            <li>
              ...
              <p>Reproduisez un site, en positionnant ces éléments, en partant d'une maquette :</p>
          ...
          <h4>Exercice pratique</h4>
          <p>Vous pouvez maintenant continuer votre exercice pratique. En y ajoutant deux colonnes, ou plus.</p>
        </article>
        <article class="tab-pane fade" id="responsive" role="tabpanel" aria-labelledby="responsive-tab">
          ...
          <h4>Exercice pratique</h4>
          <p>Vous pouvez maintenant continuer votre exercice pratique en l'adaptant pour les différents écrans.</p>
        </article>
        <article class="tab-pane fade" id="css-animation" role="tabpanel" aria-labelledby="css-animation-tab">
            ...
            <h4>Exercice pratique</h4>
            <p>Vous pouvez maintenant continuer votre exercice pratique en y ajoutant des transitions et des animations.
            Ajoutez des transitions sur les éléments cliquables.
              Et faite apparaître des éléments avec une animation.</p>
        </article>
        <article class="tab-pane fade" id="validation1" role="tabpanel" aria-labelledby="validation1-tab">
            ...
            <ol>
              <li>
                <h6>Reproduisez le site, selon la maquette</h6>
                <p>Précisions :</p>
                <ul>
              ...
              <li>
                <h6>Mini-jeu <small>(Facultatif)</small></h6>
                <p>Reproduisez le mini-jeu, selon l'exemple et les objectifs demandés.</p>
        ...
        <article class="tab-pane fade" id="js-initiation" role="tabpanel" aria-labelledby="js-initiation-tab">
          <h3>JavaScript initiation : <small>Première partie</small></h3>
           ...
           <h4>Exercices</h4>
            <ol>
              ...
              <li>
                ...
                <p>Reproduisez le site, avec ces fenêtres modal, en les construisant en JavaScript et non en HTML.
           ...
           <h4>Exercice pratique</h4>
           <p>Vous pouvez maintenant continuer votre exercice pratique. Dynamiser votre cv ou votre porte folio,
             <b>avec un fichier JavaScript lié</b>.
             Par exemple, faite appraître votre formulaire de contact avec une fenêtre modale.</p>
        </article>
          ...
          <h3>JavaScript initiation : <small>Deuxième partie</small></h3>
           ...
           <ol>
             <li>
               ...
               <p>Repoduisez le site, avec sa galerie d'image.
             ...
             <li>
               <h6>Menu à onglet</h6>
               <p>Repoduisez le site, avec son menu à onglet.
             ...
             <li>
               ...
               <p><small><b>Aidez-vous de la documentation fournie pour utiliser les méthodes liées aux tableaux.</b></small></p>
           ...
           <h4>Exercice pratique</h4>
           <p>Vous pouvez maintenant continuer votre exercice pratique pour le dynamiser.
             Par exemple pour un portfolio vous pouvez faire une galerie d'image en objet.
             Pour un cv vous pouvez faire un menu à onglet ou un menu accordéon.</p>
           <h4>Quiz</h4>
          ...
          <h3>JavaScript : <small>Vérification d'un formulaire</small></h3>
           ...
           <ol>
             ...
             <li>
               ...
               <p>Repoduisez le site, avec son formulaire dynamique.
           ...
           <h4>Exercice pratique</h4>
           <p>Vous pouvez maintenant continuer votre exercice pratique.
             En y ajoutant un message de vérification et une page de confirmation à votre formulaire de contact.</p>
        </article>
          ...
          <h3>JavaScript : <small>Gestion du temps</small></h3>
           ...
           <ol>
             ...
             <li>
               ...
               <p><small><b>Certaines notions ne sont pas dans le cours. À vous de chercher la solution avec les supports mis à disposition.</b></small></p>
           ...
           <h4>Exercice pratique</h4>
           <p>Vous pouvez maintenant continuer votre exercice pratique pour le dynamiser.
             Ajouter des actions temporelles à vos évènements, par exemple pour y ajouter des transition ou des animations.</p>
        </article>
        ...
        <article class="tab-pane fade" id="avancee" role="tabpanel" aria-labelledby="avancee-tab">
            ...
            <p>Vous avez fini le programme, vous avez désormais toutes les notions de bases en HTML/CSS et JavaScript.
              ...
              <p>Ensuite, pour aller plus loin, vous pouvez faire les exercices et les quiz suivant :</p>
