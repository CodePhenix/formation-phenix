...
[_lien vers l'exercice_](https://codephenix.fr/interface/exercices/new_exo_CSS_JS/exo-dark-theme.zip)
...
**Hop hop hop**, mais on ne va pas faire ça _à la main_, un par un !
...
Si je veux par exemple remplacer toutes les occurences de la couleur de texte des boutons, il me suffit de faire `ctrl+maj+H`, puis de remplacer `#eeeded` par `var(--color-button-text)` (si c'est le nom de ma variable déclarée plus haut, égale à `#fff`), en cliquant sur _Replace all_.
...
### Etape 3 : Ajouter les nouvelles couleurs du thème _dark_
...
### Etape 4 : Gestion du thème _dark_ en JavaScript
...
- utilisez la méthode JavaScript `addEventListener()` pour pouvoir _écouter_ le `click` sur ce bouton.
