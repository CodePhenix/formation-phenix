...
Pour cela, vous avez découvert le CSS. Pour rappel, son rôle est uniquement de s'occuper de l'apparence d'un site. Et devinez quoi ? Nous allons nous exercer un peu avec du CSS !
...
- I - 2/ CSS : {{ codephenix_url }}/cours/index.php#css-initiation

## Definition of Done

- [ ] La maquette est bien reproduite (pixel perfect)
- [ ] Utilisation de bon sélecteur css
- [ ] Respect pris en compte de l'héritage en CSS (parent/enfant)
